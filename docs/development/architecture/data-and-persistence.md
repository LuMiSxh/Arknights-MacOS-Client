...
| Launcher and runtime logs   | `~/Library/Logs/com.lumisxh.arknights-client`                                                                                | `LauncherLog` and runtime process output   | `launcher.log`, `arknights-yostar.log`, `arknights-hypergryph.log`, `unity.log`, and `chromium.log`; **Show Logs** prepares them |
